...
from build_envs.sensors import space_utils
...
class LocomotionGymEnv(gym.Env):
    ...
    def __init__(self,
        ...
        action_upper_bound = []
        action_lower_bound = []
        if self._motor_control_mode == MotorControlMode.POSITION:
            action_config = robot_class.POSITION_ACTION_CONFIG
        elif self._motor_control_mode == MotorControlMode.TORQUE:
            action_config = robot_class.TORQUE_ACTION_CONFIG
        else:
            action_config = []
