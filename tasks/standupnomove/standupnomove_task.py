...
import random
class StandupnomoveTask(object):
    def __init__(self,
                 weight=1.0,
                 pose_weight=0.5,
    ...
    def _reward_of_pos(self):
        self._get_pos_vel_info()
        height_reward = math.exp(1 + self.body_pos[2]) - math.e
        center_reward = - (self.body_pos[0] + self.body_pos[1])**2
        reward = height_reward + center_reward
        return reward
